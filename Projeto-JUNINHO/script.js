...
let invaderDirection = 1; // 1 para direita, -1 para esquerda
...
setInterval(moveInvaders, 500); // Movimento horizontal a cada 0.5s

updateGame(); // loop de animação e colisão contínua
